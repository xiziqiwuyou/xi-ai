...
hooks:
  after_create:
    - "C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py current --source`.
