...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py add-context <task> implement ".trellis/spec/backend/error-handling.md" "Error handling conventions"
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py add-context <task> check ".trellis/spec/backend/error-handling.md" "Review error handling"
```
