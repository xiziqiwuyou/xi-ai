...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py create "<child title>" --slug <child-slug> --parent <parent-dir>
```

Link or unlink existing tasks with:

```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py add-subtask <parent-dir> <child-dir>
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py remove-subtask <parent-dir> <child-dir>
```
...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py create "<title>" --slug <slug>
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py start <task>
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py current --source
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py add-context <task> implement <file> <reason>
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py validate <task>
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py finish
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py archive <task>
```
