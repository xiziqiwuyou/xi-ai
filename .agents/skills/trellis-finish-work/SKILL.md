...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/get_context.py --mode record
```
...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/task.py archive <task-name>
```
...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/add_session.py \
  --title "Session Title" \
  --commit "hash1,hash2" \
