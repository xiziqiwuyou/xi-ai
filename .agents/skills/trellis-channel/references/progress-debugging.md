...
trellis channel messages <channel> --raw --kind progress --last 80 \
  | C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe -c 'import json,sys; [print((json.loads(l).get("detail") or {}).get("text_delta",""), end="") for l in sys.stdin if l.strip()]'
```
