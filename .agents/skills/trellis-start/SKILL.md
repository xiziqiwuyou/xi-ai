...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/get_context.py
```
...
```bash
C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/get_context.py --mode phase
```
...
- **Active task status `in_progress`** → Phase 2 step 2.1. Load the step detail:
  ```bash
  C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/get_context.py --mode phase --step 2.1 --platform codex
  ```
