...
Usage:
    C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe add_session.py --title "Title" --commit "hash" --summary "Summary" [--package cli]
    C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe add_session.py --title "Title" --branch "feat/my-branch"

    # Pipe detailed content via stdin (use --stdin to opt in):
    cat << 'EOF' | C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe add_session.py --stdin --title "Title" --summary "Summary"
    <session content here>
    EOF

    # Structured content (repeatable; a section with no bullets is omitted):
    C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe add_session.py --title "Title" --change "Did X" --test "Ran Y" --next-step "Do Z"
