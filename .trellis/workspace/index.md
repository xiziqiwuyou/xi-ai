...
1. Get your developer name:
   ```bash
   C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/get_developer.py
   ```

2. Read your personal index:
   ```bash
   cat .trellis/workspace/$(C:/Users/56252/AppData/Local/Programs/Python/Python312/python.exe ./.trellis/scripts/get_developer.py)/index.md
   ```
